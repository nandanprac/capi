 ...
 */
class Version20150430101709 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE question_views (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, practo_account_id INT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_211B8D831E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE doctor_notifications (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, practo_account_id INT NOT NULL, notification_text VARCHAR(255) NOT NULL, is_viewed SMALLINT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_5B44780F1E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE question_bookmarks (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, practo_account_id INT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_710785DB1E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE questions (id INT AUTO_INCREMENT NOT NULL, user_info_id INT DEFAULT NULL, practo_account_id INT NOT NULL, question_text VARCHAR(360) NOT NULL, state VARCHAR(5) NOT NULL, is_user_anonymous SMALLINT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_8ADC54D5586DFF2 (user_info_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE question_images (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, url LONGTEXT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_E74291621E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE doctor_replies (id INT AUTO_INCREMENT NOT NULL, answer_text LONGTEXT NOT NULL, is_selected SMALLINT NOT NULL, viewed_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, doctorQuestion_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_33AD0487CCE7A081 (doctorQuestion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient_notifications (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, practo_account_id INT NOT NULL, notification_txt LONGTEXT NOT NULL, is_viewed SMALLINT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_A187FE271E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_info (id INT AUTO_INCREMENT NOT NULL, practo_account_id INT NOT NULL, allergies LONGTEXT NOT NULL, medication LONGTEXT NOT NULL, prev_diagnosed_conditions LONGTEXT NOT NULL, additional_details LONGTEXT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE question_tags (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, tag VARCHAR(127) NOT NULL, is_user_defined SMALLINT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_315279C91E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reply_ratings (id INT AUTO_INCREMENT NOT NULL, doctor_reply_id INT DEFAULT NULL, practo_account_id INT NOT NULL, ratings SMALLINT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_delete SMALLINT NOT NULL, INDEX IDX_D3086E0B22FA3C49 (doctor_reply_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reply_ratings ADD CONSTRAINT FK_D3086E0B22FA3C49 FOREIGN KEY (doctor_reply_id) REFERENCES doctor_replies (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE reply_ratings DROP FOREIGN KEY FK_D3086E0B22FA3C49');
