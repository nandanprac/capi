 ...
 */
class Version20150714105554 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE admin_users DROP practo_account_id');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE admin_users ADD practo_account_id INT NOT NULL');
