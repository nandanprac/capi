...
class Version20150502135543 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_info (id INT AUTO_INCREMENT NOT NULL, practo_account_id INT NOT NULL, allergies LONGTEXT NOT NULL, medications LONGTEXT NOT NULL, prev_diagnosed_conditions LONGTEXT NOT NULL, additional_details LONGTEXT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, soft_deleted SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
