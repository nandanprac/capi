...
/**
 * @ORM\Entity(repositoryClass="ConsultORMBundle\Repository\QuestionRepository")
...
class QuestionEntity extends BaseEntity {
    ...
    */
    ...
    /**
     * @ManyToOne(targetEntity="PatientAdditionalInfo")
     * @JoinColumn(name="patient_additional_info_id", referencedColumnName="id")
     **/
